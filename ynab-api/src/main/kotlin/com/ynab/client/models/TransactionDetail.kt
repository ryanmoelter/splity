 ...
 * @property payeeName
 * @property categoryName The name of the category.  If a split transaction, this will be &#39;Split&#39;.
 * @property subtransactions If a split transaction, the subtransactions.
 */
...
data class TransactionDetail(
    ...
    @Json(name = "cleared") @field:Json(name = "cleared") var cleared: TransactionDetail.ClearedEnum,
    ...
    @Json(name = "subtransactions") @field:Json(name = "subtransactions") var subtransactions: List<SubTransaction>,
    @Json(name = "memo") @field:Json(name = "memo") var memo: String? = null,
    @Json(name = "flag_color") @field:Json(name = "flag_color") var flagColor: TransactionDetail.FlagColorEnum? = null,
    ...
    @Json(name = "debt_transaction_type") @field:Json(name = "debt_transaction_type") var debtTransactionType: TransactionDetail.DebtTransactionTypeEnum? = null,
