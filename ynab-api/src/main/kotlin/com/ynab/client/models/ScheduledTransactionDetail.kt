...
data class ScheduledTransactionDetail(
    ...
    @Json(name = "frequency") @field:Json(name = "frequency") var frequency: ScheduledTransactionDetail.FrequencyEnum,
    ...
    @Json(name = "subtransactions") @field:Json(name = "subtransactions") var subtransactions: List<ScheduledSubTransaction>,
    @Json(name = "memo") @field:Json(name = "memo") var memo: String? = null,
    @Json(name = "flag_color") @field:Json(name = "flag_color") var flagColor: ScheduledTransactionDetail.FlagColorEnum? = null,
