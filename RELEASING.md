...
I've set up GitHub actions to automatically release this library when we add a "vX.Y.Z" tag.
...
7. When the release is built, check Docker Hub for the new image.
