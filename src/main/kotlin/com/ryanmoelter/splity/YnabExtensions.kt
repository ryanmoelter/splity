...
data class AccountAndBudget(
  val accountId: AccountId,
  val accountPayeeId: PayeeId,
...
fun TransactionDetail.ClearedEnum.toSaveTransactionClearedEnum() =
  when (this) {
...
fun TransactionDetail.FlagColorEnum.toSaveTransactionFlagColorEnum() =
  when (this) {
