  ...
  fun createDifferentialActionsForBothAccounts(): List<TransactionAction> {
    ...
    unprocessedFirstTransactions
      .forEach { transactionDetail ->
        ...
        val transactionToMatch =
          when (transactionDetail.processedState) {
        ...
        val replacedMatch =
          repository.findReplacedComplementOf(
            transactionToMatch,
    ...
    return complementPairs
      .filter { (transaction, complement) ->
        val complementNeedsProcessing =
          when (complement?.processedState) {
        ...
        createAction(
          ...
          toAccountAndBudget =
            if (fromTransaction.budgetId == firstAccountAndBudget.budgetId) {
