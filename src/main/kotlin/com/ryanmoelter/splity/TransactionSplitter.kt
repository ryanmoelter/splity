...
class TransactionSplitter(
  ...
  suspend fun splitFlaggedTransactions() {
    ...
    val unprocessedFlaggedTransactions =
      repository
        .getUnprocessedAndFlaggedTransactionsInAccountsExcept(
    ...
    unprocessedFlaggedTransactions
      .forEach { transaction ->
        ...
        transaction.splitIntoSplitAccount(
          splitAccountPayeeId =
            if (transaction.budgetId == syncData.firstBudgetId) {
  ...
  private suspend fun PublicTransactionDetail.splitIntoSplitAccount(splitAccountPayeeId: PayeeId) {
    ...
    val response =
      ynabClient.transactions.updateTransaction(
