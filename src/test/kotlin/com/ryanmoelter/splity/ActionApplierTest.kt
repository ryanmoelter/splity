...
class ActionApplierTest :
  FunSpec({
    ...
    test("create from split transfer") {
      ...
      val complement =
        transactionList.find { transactionDetail ->
          transactionDetail
            .toPublicTransactionDetail(TO_BUDGET_ID, UP_TO_DATE)
    ...
    test("create from split transfer: recurring transaction") {
              ...
              listOf(
                ...
                subTransactionTransferSplitSource(UP_TO_DATE).copy(
                  transferTransactionId =
                    subTransactionTransferSplitSource(UP_TO_DATE)
      ...
      assertSoftly(transactionList.first()) {
        ...
        importId shouldBe
          "splity:${-transactionAddedFromTransferWithLongId.amount}:${transactionAddedFromTransferWithLongId.date}:1"
